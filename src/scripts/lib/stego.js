...
function n(t, r) {
	var n,
		i,
		e = Array.from(Array(r).keys()),
		o = [],
		a = y.SHA512(t).words.reduce(function (t, r) {
			return t + Math.abs(r);
		}, 0),
		h = new b(a);
	...
	for (e = 0; e < 8; e++)
		for (o = 0; o < 8; o++) {
			for (r = 0 == e ? 1 / Math.sqrt(2) : 1, n = 0 == o ? 1 / Math.sqrt(2) : 1, i = 0, a = 0; a < 8; a++)
				for (h = 0; h < 8; h++) i += t[8 * a + h] * Math.cos(((2 * a + 1) * e * Math.PI) / 16) * Math.cos(((2 * h + 1) * o * Math.PI) / 16);
			s[8 * e + o] = 0.25 * r * n * i;
		}
	return s;
}
			...
			(m = c(t, 16, 16 * g, 16 * p, r)),
				...
				0 != g || 0 != p
					? ((v = y.map(function (t, r) {
					  ...
					  (_ = e(
							(y = y.map(function (t, r) {
								return t + M[r];
							}))
					  )),
					  (A = u(
							(A = _.map(function (t, r) {
								return t - w[r];
							}))
					  )),
					  l(
...
function writeMsgToCanvas_base(i, e, o, a, h, s, u, c, l) {
	...
	try {
		return (
			(y = (w = (m = document.getElementById(i)).getContext("2d")).getImageData(0, 0, m.width, m.height)),
			...
			a
				? (function (n, i, e, o, a, h, s, u) {
						...
						for (
							s && d(A, i, e, o.slice(0, M), a, h), (m = u ? g : d)(S, i, e, o.slice(M, M + _), a, h), m(B, i, e, o.slice(M + _, M + _ + _), a, h), w = 0, c = 0;
							c < n.data.length;
							c += 4
						)
		...
		return null ==
			(l = (function (t, r) {
				...
				var i,
					...
					a,
					h = Array(),
					s = Math.floor(Math.floor(t.length / r) / 8);
				for (o = 0; o < s; o++) {
			...
			B.extend({
				...
				concat: function (t) {
					var r,
						...
						i = t.words,
						e = this.sigBytes;
					if (((t = t.sigBytes), this.clamp(), e % 4)) for (r = 0; r < t; r++) n[(e + r) >>> 2] |= ((i[r >>> 2] >>> (24 - (r % 4) * 8)) & 255) << (24 - ((e + r) % 4) * 8);
