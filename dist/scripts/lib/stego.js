...
function t(t, r, n) {
    return [0.299 * t + 0.587 * r + 0.114 * n, 128 - 0.168736 * t - 0.331264 * r + 0.5 * n, 128 + 0.5 * t - 0.418688 * r - 0.081312 * n];
}
function r(t, r, n) {
    return [t + 1.402 * (n - 128), t - 0.344136 * (r - 128) - 0.714136 * (n - 128), t + 1.772 * (r - 128)];
}
function n(t, r) {
    ...
    for (i = r; i > 0; i--)
        (n = h.genrand_int32() % i), o.push(e[n]), (e[n] = e[i - 1]);
    return o;
}
function i(t) {
    ...
    for (e = 0; e < 8; e++)
        for (o = 0; o < 8; o++) {
            for (r = 0 == e ? 1 / Math.sqrt(2) : 1, n = 0 == o ? 1 / Math.sqrt(2) : 1, i = 0, a = 0; a < 8; a++)
                for (h = 0; h < 8; h++)
                    i += t[8 * a + h] * Math.cos(((2 * a + 1) * e * Math.PI) / 16) * Math.cos(((2 * h + 1) * o * Math.PI) / 16);
            s[8 * e + o] = 0.25 * r * n * i;
        }
    return s;
}
function e(t) {
    var r, n, i, e, o;
    for (result = Array(64).fill(0), n = 0; n < 8; n++)
        for (i = 0; i < 8; i++) {
            for (r = 0, e = 0; e < 8; e++)
                for (o = 0; o < 8; o++)
                    r += (0 == e ? 1 / Math.sqrt(2) : 1) * (0 == o ? 1 / Math.sqrt(2) : 1) * t[8 * e + o] * Math.cos(((2 * n + 1) * e * Math.PI) / 16) * Math.cos(((2 * i + 1) * o * Math.PI) / 16);
            result[8 * n + i] = 0.25 * r;
        }
    return result;
}
function o(t) {
    var r, n = [
        16, 11, 10, 16, 24, 40, 51, 61, 12, 12, 14, 19, 26, 58, 60, 55, 14, 13, 16, 24, 40, 57, 69, 56, 14, 17, 22, 29, 51, 87, 80, 62, 18, 22, 37, 56, 68, 109, 103, 77, 24, 35, 55, 64, 81,
...
function a(t, r, n, i) {
    ...
    for (e = o(t), a = Array(64).fill(0), f = 0; f < r.length; f++)
        (h = n[r[f]] / e[r[f]]),
            (s = Math.floor(h)),
            Math.abs(s % 2) != i[f] && (s -= 1),
            (u = Math.ceil(h)),
            Math.abs(u % 2) != i[f] && (u += 1),
            h - s > u - h && (s = u),
            (a[r[f]] = s * e[r[f]] - n[r[f]]);
    return a;
}
function h(t, r, n) {
    ...
    for (i = 0; i < r.length; i++)
        a.push(Math.abs(Math.round(n[r[i]] / e[r[i]]) % 2));
    return a;
}
function s(t) {
    var r, n, i = Array(64);
    for (r = 0; r < 8; r++)
        for (n = 0; n < 8; n++)
            i[8 * r + n] = (t[2 * r * 8 + 2 * n] + t[8 * (2 * r + 1) + 2 * n] + t[2 * r * 8 + 2 * n + 1] + t[8 * (2 * r + 1) + 2 * n + 1]) / 4;
    return i;
}
function u(t) {
    var r, n, i = Array(256);
    for (r = 0; r < 16; r++)
        for (n = 0; n < 16; n++)
            i[16 * r + n] = t[8 * Math.floor(r / 2) + Math.floor(n / 2)];
    return i;
}
function f(t) {
...
function d(t, r, n, o, h, s) {
    ...
    for (f = 0; f < w; f++)
        for (d = 0; d < y; d++)
            (g = i(c(t, 8, 8 * f, 8 * d, r))),
                0 != f || 0 != d
                    ? ((p = g.map(function (t, r) {
                        return t - u[r];
                    })),
                        (m = a(h, s, p, o.slice(v * (f * y + d - 1), v * (f * y + d)))),
                        l(t, 8, 8 * f, 8 * d, r, e((g = g.map(function (t, r) {
                            return t + m[r];
                        })))))
                    : (u = g);
}
function g(t, r, n, o, h, f) {
    ...
    for (g = 0; g < S; g++)
        for (p = 0; p < B; p++)
            (m = c(t, 16, 16 * g, 16 * p, r)),
                (y = i((w = s(m)))),
                0 != g || 0 != p
                    ? ((v = y.map(function (t, r) {
                        return t - d[r];
                    })),
                        (M = a(h, f, v, o.slice(I * (g * B + p - 1), I * (g * B + p)))),
                        (_ = e((y = y.map(function (t, r) {
                            return t + M[r];
                        })))),
...
function writeMsgToCanvas_base(i, e, o, a, h, s, u, c, l) {
    ...
    (a = void 0 !== a && a),
        ...
        (h = void 0 === h ? 5 : h),
        (s = void 0 === s ? 30 : s),
        (u = void 0 === u ? [1, 2, 8, 9, 10, 16, 17] : u),
        (c = void 0 === c || c),
        (l = void 0 === l || l);
    try {
        return ((y = (w = (m = document.getElementById(i)).getContext("2d")).getImageData(0, 0, m.width, m.height)),
            (v = 3 * Math.floor(y.data.length / 4)),
            a && (v = (M = p(m.width, m.height, u, c, l))[0] + 2 * M[1]),
            (_ = (function (t, r, i) {
                var e, o, a, h = t.length;
                if (t.length > i)
                    throw "Can not hold this many data!";
                for (e = Array(i), o = 0; o < i; o++)
                    e[o] = Math.floor(2 * Math.random());
                for (a = n(r, i), o = 0; o < h; o++)
                    e[a[o]] = t[o];
                return e;
            })((_ = (function (t, r) {
                var n, i, o, a = (function (t) {
                    var r, n, i = [], e = 0;
                    for (r = (t = encodeURI(t)).length; e < r;)
                        (n = t[e]), (e += 1), "%" !== n ? i.push(n.charCodeAt(0)) : ((n = t[e] + t[e + 1]), i.push(parseInt(n, 16)), (e += 2));
                    return i;
                })(e), h = Array(), s = a.length;
                for (n = 0; n < s; n++)
                    for (i = 128; i > 0; i = Math.floor(i / 2))
                        if (Math.floor(a[n] / i)) {
                            for (o = 0; o < r; o++)
                                h.push(1);
                            a[n] -= i;
            ...
            a
                ? (function (n, i, e, o, a, h, s, u) {
                    var c, l, m, w, y, v = p(i, e, h, s, u), M = v[0], _ = v[1], A = Array(), S = Array(), B = Array();
                    for (c = 0; c < n.data.length; c += 4)
                        (l = t(n.data[c], n.data[c + 1], n.data[c + 2])), A.push(l[0]), S.push(l[1]), B.push(l[2]);
                    for (s && d(A, i, e, o.slice(0, M), a, h), (m = u ? g : d)(S, i, e, o.slice(M, M + _), a, h), m(B, i, e, o.slice(M + _, M + _ + _), a, h), w = 0, c = 0; c < n.data.length; c += 4)
                        (y = r(A[w], S[w], B[w])), (n.data[c] = f(y[0])), (n.data[c + 1] = f(y[1])), (n.data[c + 2] = f(y[2])), (w += 1);
                })(y, m.width, m.height, _, s, u, c, l)
                : (function (t, r) {
                    function n(t) {
                        return t % 2 == 1 ? t - 1 : t;
                    }
                    ...
                    var e, o = 0;
                    for (e = 0; e < t.data.length; e += 4)
                        (t.data[e] = r[o] ? i(t.data[e]) : n(t.data[e])),
                            (t.data[e + 1] = r[o + 1] ? i(t.data[e + 1]) : n(t.data[e + 1])),
                            (t.data[e + 2] = r[o + 2] ? i(t.data[e + 2]) : n(t.data[e + 2])),
                            (t.data[e + 3] = 255),
                            (o += 3);
                })(y, _),
...
function m(t, r, n, e, o) {
    ...
    for (s = 0; s < l; s++)
        for (u = 0; u < d; u++)
            (f = i(c(t, 8, 8 * s, 8 * u, r))),
                0 != s || 0 != u
                    ? g.push(h(e, o, f.map(function (t, r) {
                        return t - a[r];
                    })))
                    : (a = f);
...
function w(t, r, n, e, o) {
    ...
    for (u = 0; u < d; u++)
        for (f = 0; f < g; f++)
            (l = i(s(c(t, 16, 16 * u, 16 * f, r)))),
                0 != u || 0 != f
                    ? p.push(h(e, o, l.map(function (t, r) {
                        return t - a[r];
                    })))
                    : (a = l);
    ...
    try {
        return null ==
            (l = (function (t, r) {
                ...
                for (o = 0; o < s; o++) {
                    for (i = 0, e = 128, a = 0; a < 8; a++)
                        (i += n(t.slice((8 * o + a) * r, (8 * o + a + 1) * r)) * e), (e = Math.floor(e / 2));
                    if (255 == i)
                        break;
                    h.push(i);
                }
                return (function (t) {
                    for (var r, n, i, e = [], o = 0, a = t.length; o < a;)
                        (r = t[o]),
                            (n = t[o + 1]),
                            (i = t[o + 2]),
                            128 > r
                                ? (e.push(String.fromCharCode(r)), (o += 1))
                                : 191 < r && r < 224
                                    ? (e.push(String.fromCharCode(((31 & r) << 6) | (63 & n))), (o += 2))
                                    : (e.push(String.fromCharCode(((15 & r) << 12) | ((63 & n) << 6) | (63 & i))), (o += 3));
                    return e.join("");
                })(h);
            })((function (t, r) {
                ...
                ? (function (r, n, i, e, o, a, h) {
                    var s, u, f, c = Array(), l = Array(), d = Array(), g = Array();
                    for (s = 0; s < r.data.length; s += 4)
                        (u = t(r.data[s], r.data[s + 1], r.data[s + 2])), c.push(u[0]), l.push(u[1]), d.push(u[2]);
                    return a && g.push(m(c, n, i, e, o)), (f = h ? w : m), g.push(f(l, n, i, e, o)), g.push(f(d, n, i, e, o)), [].concat.apply([], g);
                })(c, f.width, f.height, a, h, s, u)
                : (function (t) {
                    var r, n = Array();
                    for (r = 0; r < t.data.length; r += 4)
                        n.push(t.data[r] % 2 == 1 ? 1 : 0), n.push(t.data[r + 1] % 2 == 1 ? 1 : 0), n.push(t.data[r + 2] % 2 == 1 ? 1 : 0);
                    return n;
                })(c), i), o))
            ? [!1, "Message does not decrypt. Maybe due to (1) wrong password / enc method. (2) corrupted file"]
            : [!0, l];
    }
    catch (t) {
...
function loadIMGtoCanvas(t, r, n, i) {
    var e, o, a;
    if (((i = void 0 === i ? 0 : i), !(e = document.getElementById(t)).files || !e.files[0]))
        return alert("NO IMG FILE SELECTED"), "ERROR PROCESSING IMAGE!";
    (o = e.files[0]),
        ((a = new FileReader()).onload = function (t) {
            var e = t.target.result, o = new Image();
            (o.onload = function () {
                var t, e = o.width, a = o.height;
                i > 0 && (e > i && ((a *= i / e), (e = i)), a > i && ((e *= i / a), (a = i)), (e = Math.floor(e)), (a = Math.floor(a))),
                    ((t = document.createElement("canvas")).id = r),
                    (t.width = e),
                    (t.height = a),
                    (t.style.display = "none"),
                    document.getElementsByTagName("body")[0].appendChild(t),
                    t.getContext("2d").drawImage(o, 0, 0, o.width, o.height, 0, 0, e, a),
                    n(),
...
(b.prototype.init_genrand = function (t) {
    ...
    (b.prototype.init_by_array = function (t, r) {
        var n, i, e, o;
        for (this.init_genrand(19650218), n = 1, i = 0, e = this.N > r ? this.N : r; e; e--)
            (o = this.mt[n - 1] ^ (this.mt[n - 1] >>> 30)),
                (this.mt[n] = (this.mt[n] ^ (((1664525 * ((4294901760 & o) >>> 16)) << 16) + 1664525 * (65535 & o))) + t[i] + i),
                (this.mt[n] >>>= 0),
                i++,
    ...
    (b.prototype.genrand_int32 = function () {
        ...
        if (this.mti >= this.N) {
            ...
            for (; r < this.N - 1; r++)
                (t = (this.mt[r] & this.UPPER_MASK) | (this.mt[r + 1] & this.LOWER_MASK)), (this.mt[r] = this.mt[r + (this.M - this.N)] ^ (t >>> 1) ^ n[1 & t]);
                ...
                (E = C.Hex =
                    {
                        stringify: function (t) {
                            var r, n, i, e = t.words;
                            for (t = t.sigBytes, r = [], n = 0; n < t; n++)
                                (i = (e[n >>> 2] >>> (24 - (n % 4) * 8)) & 255), r.push((i >>> 4).toString(16)), r.push((15 & i).toString(16));
                            return r.join("");
                        },
                        parse: function (t) {
                            for (var r = t.length, n = [], i = 0; i < r; i += 2)
    ...
    (function (t) {
        ...
        ((r = r.x64 = {}).Word = i.extend({
            ...
            (r.WordArray = i.extend({
                ...
                toX32: function () {
                    var t, r, n, i, o;
                    for (r = (t = this.words).length, n = [], i = 0; i < r; i++)
                        (o = t[i]), n.push(o.high), n.push(o.low);
                    return e.create(n, this.sigBytes);
                },
                clone: function () {
                    for (var t = i.clone.call(this), r = (t.words = this.words.slice(0)), n = r.length, e = 0; e < n; e++)
                        r[e] = r[e].clone();
                    return t;
                }
            }));
    ...
    (function () {
        ...
        for (var r = y, n = r.lib.Hasher, i = (o = r.x64).Word, e = o.WordArray, o = r.algo, a = [
        ...
        (o = o.SHA512 =
            n.extend({
                ...
                _doProcessBlock: function (t, r) {
                    var n, i, e, o, s, u, f, c, l, d, g, p, m, w, y, v, M, _, A, S, B, I, C, E, N, R, x, b, P, z, H, O, D, U, W, L, k, K, T, F, q, X, j, G, $, Y, J, Q, V, Z, tt, rt, nt;
                    for (i = (n = this._hash.words)[0],
                        e = n[1],
                        o = n[2],
                        s = n[3],
                        u = n[4],
                        ...
                        (X = h[q]),
                            16 > q
                                ? ((j = X.high = 0 | t[r + 2 * q]), (G = X.low = 0 | t[r + 2 * q + 1]))
                                : ((j = (((G = (j = h[q - 15]).high) >>> 1) | (($ = j.low) << 31)) ^ ((G >>> 8) | ($ << 24)) ^ (G >>> 7)),
                                    ($ = (($ >>> 1) | (G << 31)) ^ (($ >>> 8) | (G << 24)) ^ (($ >>> 7) | (G << 25))),
                                    (Y = (((G = (Y = h[q - 2]).high) >>> 19) | ((J = Y.low) << 13)) ^ ((G << 3) | (J >>> 29)) ^ (G >>> 6)),
                                    (J = ((J >>> 19) | (G << 13)) ^ ((J << 3) | (G >>> 29)) ^ ((J >>> 6) | (G << 26))),
                                    (Q = (G = h[q - 7]).high),
                                    (Z = (V = h[q - 16]).high),
                                    (V = V.low),
                                    (j = (j = (j = j + Q + ((G = $ + G.low) >>> 0 < $ >>> 0 ? 1 : 0)) + Y + ((G += J) >>> 0 < J >>> 0 ? 1 : 0)) + Z + ((G += V) >>> 0 < V >>> 0 ? 1 : 0)),
                                    (X.high = j),
                                    (X.low = G)),
                            (Q = (D & W) ^ (~D & k)),
                            (V = (U & L) ^ (~U & K)),
                            (X = (N & x) ^ (N & P) ^ (x & P)),
                            (tt = (R & b) ^ (R & z) ^ (b & z)),
                            ($ = ((N >>> 28) | (R << 4)) ^ ((N << 30) | (R >>> 2)) ^ ((N << 25) | (R >>> 7))),
                            (Y = ((R >>> 28) | (N << 4)) ^ ((R << 30) | (N >>> 2)) ^ ((R << 25) | (N >>> 7))),
                            (rt = (J = a[q]).high),
                            (nt = J.low),
                            (Z =
                                T +
                                    (((D >>> 14) | (U << 18)) ^ ((D >>> 18) | (U << 14)) ^ ((D << 23) | (U >>> 9))) +
                                    ((J = F + (((U >>> 14) | (D << 18)) ^ ((U >>> 18) | (D << 14)) ^ ((U << 23) | (D >>> 9)))) >>> 0 < F >>> 0 ? 1 : 0)),
                            (T = k),
                            (F = K),
                            (k = W),
                            (K = L),
                            ...
                            (D =
                                (H +
                                    (Z = (Z = (Z = Z + Q + ((J += V) >>> 0 < V >>> 0 ? 1 : 0)) + rt + ((J += nt) >>> 0 < nt >>> 0 ? 1 : 0)) + j + ((J += G) >>> 0 < G >>> 0 ? 1 : 0)) +
                                    ((U = (O + J) | 0) >>> 0 < O >>> 0 ? 1 : 0)) |
                                    0),
                            (H = P),
                            (O = z),
                            ...
                            (x = N),
                            (b = R),
                            (N = (Z + (X = $ + X + ((G = Y + tt) >>> 0 < Y >>> 0 ? 1 : 0)) + ((R = (J + G) | 0) >>> 0 < J >>> 0 ? 1 : 0)) | 0);
                    (d = i.low = d + R),
                        (i.high = l + N + (d >>> 0 < R >>> 0 ? 1 : 0)),
                        (p = e.low = p + b),
                        (e.high = g + x + (p >>> 0 < b >>> 0 ? 1 : 0)),
                        (w = o.low = w + z),
                        (o.high = m + P + (w >>> 0 < z >>> 0 ? 1 : 0)),
                        (v = s.low = v + O),
                        (s.high = y + H + (v >>> 0 < O >>> 0 ? 1 : 0)),
                        (_ = u.low = _ + U),
                        (u.high = M + D + (_ >>> 0 < U >>> 0 ? 1 : 0)),
                        (S = f.low = S + L),
                        (f.high = A + W + (S >>> 0 < L >>> 0 ? 1 : 0)),
                        (I = c.low = I + K),
                        (c.high = B + k + (I >>> 0 < K >>> 0 ? 1 : 0)),
                        (E = n.low = E + F),
                        (n.high = C + T + (E >>> 0 < F >>> 0 ? 1 : 0));
                },
            ...
            (r.SHA512 = n._createHelper(o)),
            (r.HmacSHA512 = n._createHmacHelper(o));
    })();
